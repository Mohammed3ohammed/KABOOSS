  ...
  return (
    <>
      <div className='flex justify-center'>
        <h1 className='text-3xl font-bold mt-10 italic text-red-800'>{t("coatch5.title")}</h1>
      </div>
      <div>
            ...
            <section className="py-12 px-6 lg:px-20">
              <div className="max-w-4xl mx-auto p-8 shadow-lg rounded-2xl">
                ...
                <form onSubmit={handleSubscribe} className='flex flex-col gap-5 lg:w-8/12 p-4 md:w-8/12 w-full justify-center'>
                  ...
                  <button 
                    type="submit" 
                    className="border-2 border-solid border-red-800 py-2 px-6 mt-5 rounded-full text-white hover:bg-red-800 hover:text-white transition duration-300 w-full sm:w-auto text-center cursor-pointer"
                  >
                    {t("button")}
                  </button>
                </form>
